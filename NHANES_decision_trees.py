...
def main():
    ...
    # Visualize the tree
    visualize_tree(tree, filename="basic_tree", feature_names=feature_names)
    ...
    visualize_tree(tree2, filename="underfit_tree", feature_names=feature_names)
    ...
    visualize_tree(tree3, max_depth=5, filename="overfit_tree", feature_names=feature_names) # visualize only top 5 levels
    ...
    visualize_tree(tree4, max_depth=5, filename="min_samples_split_2000", feature_names=feature_names)
    ...
    visualize_tree(tree5, max_depth=5, filename="min_samples_split_2", feature_names=feature_names)
    """
...
def visualize_tree(model, max_depth=5, filename="tree", feature_names=None):
        """
...
def build_all_models(max_depths, min_samples_split, criterion, 
